...
use App\Services\Kategori as KategoriService;
use Config\Services;
...
class Kategori extends BaseController
{
    ...
    public function index()
    {
        ...
        $result = $this->kategoriService->getData($search, $limit, $offset);

        if ($this->isApi()) {
            return $this->apiResponse(true, 'Data kategori berhasil diambil', 200, [
                'data'  => $result['data'],
    ...
    public function store()
    {
        ...
        if (empty($data['kategori'])) {
            if ($this->isApi()) {
                return $this->apiResponse(false, 'Nama kategori harus diisi', 422);
            }
